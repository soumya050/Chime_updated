...
declare class VoiceFocusTransformDevice implements AudioTransformDevice {
    ...
    /** @internal */
    constructor(device: Device, voiceFocus: VoiceFocus, delegate: VoiceFocusTransformDeviceDelegate, nodeOptions: NodeArguments, failed?: boolean, node?: VoiceFocusAudioWorkletNode | undefined, browserBehavior?: DefaultBrowserBehavior);
    /**
